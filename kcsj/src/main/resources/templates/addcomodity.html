	...
	<div class="right">
		...
		<div class="right-content">
			<div class="info">
				<h3>添加商品</h3>
				<div class="add">
					<form action="addCommodity" method="post" enctype="multipart/form-date">
						<label>类型<span class="small">Type</span></label><input type="text"
							placeholder="请输入类型" name="type"><br> <label>名称<span
							class="small">Name</span></label> <input type="text" placeholder="请输入名称"
							name="name"><br> <label>价格<span
							class="small">Price</span></label> <input type="text" placeholder="请输入价格"
							name="price"><br> <label
							style="margin-bottom: 15px;">上传图片<span class="small">img</span></label>
						<br> <input type="file" name="img" multiple="multiple"/><br>
						<button type="submit">提交</button>
						<a href="findshopAll_admin" class="goback">返回</a>
					</form>
				</div>
			</div>
