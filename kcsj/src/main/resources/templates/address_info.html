	...
	<div class="right">
		...
		<div class="right-content">
			<div class="info">
				<h3>商品信息</h3>
<!-- 				<button class="add"> -->
<!-- 					<a href="add_address.jsp">新增</a> -->
<!-- 				</button> -->
				<form action="findAddressbyRname" method="post">
					<div class="search">
						<div class="search-box">
							<input type="text" name="receive_name" placeholder="根据收货人姓名模糊查询">
						...
						<tbody>
							<c:forEach items="${a}" var="a">
								<tr>
									...
									<td>${a.three_address}</td>
									<td>${a.other_address}</td>
									<td>${a.tel}</td>
									<td>
										<div class="operation">
											<a href="toUpdate_address?id=${a.id}">编辑</a> <a
												href="deleteAddress_admin?id=${a.id}">删除</a>
										</div>
									</td>
								</tr>
							</c:forEach>
