	...
	<div class="right">
		...
		<div class="right-content">
			<div class="info">
				...
				<div class="add">
					<form action="addUser">
						<label>用户名<span class="small">Uname</span></label><input
							type="text" placeholder="请输入用户名" name="uname"><br> <label>密码<span
							class="small">Password</span></label> <input type="text"
							placeholder="请输入密码" name="password"><br> <label>性别<span
							class="small">Sex</span></label> <select class="sex" name="sex">
							<option value="男">男</option>
							<option value="女">女</option>
						</select><br> <label>邮箱<span class="small">Email</span></label> <input
							type="text" placeholder="请输入邮箱" name="email"> <br>
						<label>手机号<span class="small">Tel</span></label> <input
							type="text" placeholder="请输入手机号" name="tel">
						<button type="submit">提交</button>
						<a href="findUser" class="goback">返回</a>
					</form>
				</div>
			</div>
