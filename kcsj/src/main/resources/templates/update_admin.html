	...
	<div class="right">
		...
		<div class="right-content">
			<div class="info">
				<h3>更改商品</h3>
				<div class="add">
					<form action="doUpdate_admin" method="post">
						<input name="id" type="hidden" value="${a.id}"> <label>用户名<span
							class="small">Uname</span></label><input type="text" placeholder="请输入用户名"
							name="uname" value="${a.uname}"><br> <label>密码<span
							class="small">Password</span></label><input type="text"
							placeholder="请输入密码" name="password" value="${a.password}"><br>
						<button type="submit">提交</button>
						<a href="findAdmin" class="goback">返回</a>
